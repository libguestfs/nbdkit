...
nbdkit 1.24.0 was released on B<XX XXXX 2021>.
...
New I<-D nbdkit.tls.log> and I<-D nbdkit.tls.session> debug flags
which enable additional debugging for TLS sessions.
