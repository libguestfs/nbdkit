...
Take a slice of the enclosed pattern.  Slices are
S<B<[>startB<:>end+1B<]>> where I<start> and I<end> are the first and
last byte offsets of the enclosed pattern desired.  Either or both may
be omitted.  S<B<[:>lenB<]>> means to take the first I<len> bytes.
S<B<[>startB<:]>> means to take bytes from offset I<start> to the end
of the enclosed pattern.
