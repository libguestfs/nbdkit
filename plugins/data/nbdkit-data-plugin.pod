...
pattern 0x55 0xAA.  See also L<nbdkit-pattern-plugin(3)>.
...
Repeat the enclosed pattern C<N> times.  For example to create a
repeating pattern of bytes 0x55, 0xAA, ... for 512 bytes do:
