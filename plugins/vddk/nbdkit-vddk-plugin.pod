...
When making a remote connection you must supply all 6 of these
parameters.

=back

See the L</EXAMPLES> section below for local and remote command lines.
...
print of a server is described in L</THUMBPRINTS> below.
