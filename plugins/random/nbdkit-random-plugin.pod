...
random data, read only.  This plugin is mainly good for testing NBD
clients.  This plugin creates a non-sparse random disk, for a sparse
random disk see L<nbdkit-sparse-random-plugin(1)>.
